 ...
 * @author Huy
 */
public class ClientMonitoringSystem extends javax.swing.JFrame {

    /**
     * Creates new form ClientMonitoringSystem
     */
    public ClientMonitoringSystem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientMonitoringSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientMonitoringSystem().setVisible(true);
            }
        });
    }
